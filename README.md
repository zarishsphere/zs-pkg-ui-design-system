...
ZarishSphere design system — Carbon DS 11.x extensions, WCAG 2.2 AA
...
```bash
git clone https://github.com/zarishsphere/zs-pkg-ui-design-system.git
cd zs-pkg-ui-design-system
pnpm install
pnpm dev
```
